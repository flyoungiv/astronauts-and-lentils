...
export default function DeveloperNotes(props) {
    ...
    return (
        <div style={notePaperStyle}>
            Developer Notes
(If you are viewing this on your phone, maybe use your computer instead! This site is not a production-ready site and not very mobile friendly.)

Hi! My name is Fleetwood Young, and this is my go at the Robots and Pencils coding challenge. You can view my code here:
...
in choosing the right tool for the job. For this reason I chose the lowdb package... the data provided was already in a .json format, so I figured why not just
lean into that. On a larger scale I would lean on a different kind of setup, like MongoDB/Firebase/some other kind of No-SQL solution, but I liked the way the
lowdb package got the job done without a bunch of overhead.

I hope you have as much fun going through my code as I did putting it together. There are tons of things I would like to improve about what I did, but
I am eager to get my work in front of you, so thought it best to just publish this work and share some of my thoughts. Looking forward to talking more!
